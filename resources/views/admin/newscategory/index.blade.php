                ...
                <div class="col-12 mb-3">
                    <div class="row justify-content-center justify-content-sm-between">
                        <div class="col-sm-auto text-center">
                            <h5 class="d-inline-block">Categories for news</h5>
                        </div>
                        <div  class="col-sm-auto text-center">
                            <div class="search-box" data-list="{&quot;valueNames&quot;:[&quot;title&quot;]}">
                                <form class="position-relative show" data-bs-toggle="search" data-bs-display="static" aria-expanded="true" action="{{route('search_news_category')}}" method="get">
                        ...
                        <table class="table table-hover table-striped overflow-hidden">
                            ...
                            @foreach($news_categories as $news_category)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div>
                                            <a href="{{route('news_category.edit' , $news_category['id'])}}" style="text-decoration: none">
                                                <button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                </button>
                                                <span class="text-500 fas fa-edit"></span>
                                            </a>
                                            <form action="{{route('news_category.destroy' , $news_category['id'])}}" method="post"
