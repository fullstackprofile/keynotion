                    ...
                    <form action="{{route('coupons.update', $coupons['id'])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gx-2">
                            <div class="col-12 mb-3">
                                ...
                                <input class="form-control" name="discount" value="{{ $coupons['discount']}}" id="event-name" type="number"  >
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label" for="event-name">Percent or Currency</label>
                                <select class="form-select" id="event-type" name="percent_amount" >
                                    @if($coupons['percent_amount']) <option selected>{{$coupons['percent_amount']}}</option>@endif
                                    <option value="%">%</option>
                                    <option value="$">$</option>
                                    <option value="€">€</option>
                                    <option value="£">£</option>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input class="form-control" name="user" value="{{ $coupons['user']}}" id="event-name" type="text" placeholder="Who should attend" >
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label" for="event-name">User's email</label>
                                <input class="form-control" name="email" value="{{ $coupons['email']}}" id="event-name" type="text" placeholder="Who should attend" >
                            </div>
                            <div class="col-sm-6 mb-3">
                                <label class="form-label" for="start-date"> Start Date <span style="color: red">*</span></label>
                                <input type="date" name="creation_date"
                                       placeholder="d/m/y"
                                       value="{{ $coupons['creation_date']}}" >
                            </div>
                            <div class="col-sm-6 mb-3">
                                <label class="form-label" for="start-date"> Expire date<span style="color: red">*</span></label>
                                <input type="date" name="expiration_date"
                                       placeholder="d/m/y"
                                       value="{{ $coupons['expiration_date']}}"  >
                            </div>
                            <div class="col-4">
