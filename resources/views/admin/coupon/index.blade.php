                ...
                <div class="col-12 mb-3">
                    <div class="row justify-content-center justify-content-sm-between">
                        <div class="col-sm-auto text-center">
                            <h5 class="d-inline-block">Coupons</h5>
                        </div>
                        <div  class="col-sm-auto text-center">
                            <div class="search-box" data-list="{&quot;valueNames&quot;:[&quot;title&quot;]}">
                                <form class="position-relative show" data-bs-toggle="search" data-bs-display="static" aria-expanded="true" action="{{route('search_coupon')}}" method="get">
                        ...
                        <table class="table table-hover table-striped overflow-hidden">
                            ...
                            @foreach($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>{{$coupon['user']}}</td>
                                    <td>{{$coupon['email']}}</td>
                                    <td>{{$coupon['creation_date']}}</td>
                                    <td>{{$coupon['expiration_date']}}</td>
                                    <td>{{$coupon['discount']}} {{$coupon['percent_amount']}}</td>
                                    <td class="text-end">
                                        <div>
                                            <a href="{{route('coupons.edit' , $coupon['id'])}}" style="text-decoration: none">
