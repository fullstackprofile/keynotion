                    ...
                    <div class="row justify-content-center justify-content-sm-between">
                        ...
                        <div  class="col-sm-auto text-center">
                            <div class="search-box" data-list="{&quot;valueNames&quot;:[&quot;title&quot;]}">
                                <form class="position-relative show" data-bs-toggle="search" data-bs-display="static" aria-expanded="true" action="{{route('search_news')}}" method="get">
                        ...
                        <table class="table table-hover table-striped overflow-hidden">
                            ...
                            @foreach($news as $new)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div>
                                            <a href="{{route('news.edit' , $new['id'])}}" style="text-decoration: none">
