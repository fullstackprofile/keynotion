...
@section('title', 'Admin - All Attenders')
@section('content')
    <div class="card mb-3">
                ...
                <div class="col-12 mb-3">
                    <div class="row justify-content-center justify-content-sm-between">
                        <div class="col-sm-auto text-center">
                            <h5 class="d-inline-block">Attenders for Event</h5>
                        </div>
                        <div  class="col-sm-auto text-center">
                            <div class="search-box" data-list="{&quot;valueNames&quot;:[&quot;title&quot;]}">
                                <form class="position-relative show" data-bs-toggle="search" data-bs-display="static" aria-expanded="true" action="{{route('search_attender')}}" method="get">
                    ...
                    <div class="table-responsive scrollbar">
                        <table class="table table-hover table-striped overflow-hidden">
                            ...
                            @foreach($attenders as $attender)
                                <tr>
                                    <td>{{$attender['id']}}</td>
                                    <td>{{$attender['title']}}</td>
                                    <td class="text-end">
                                        <div>
                                            <a href="{{route('attender.edit' , $attender['id'])}}" style="text-decoration: none">
                                                <button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                </button>
                                                <span class="text-500 fas fa-edit"></span>
                                            </a>
                                            <form action="{{route('attender.destroy' , $attender['id'])}}" method="post"
