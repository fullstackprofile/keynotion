...
@section('title', 'Admin - All Vacancies')
@section('content')
    <div class="card mb-3">
                ...
                <div class="col-12 mb-3">
                    <div class="row justify-content-center justify-content-sm-between">
                        <div class="col-sm-auto text-center">
                            <h5 class="d-inline-block">Vacancies</h5>
                        </div>
                        <div  class="col-sm-auto text-center">
                            <div class="search-box" data-list="{&quot;valueNames&quot;:[&quot;title&quot;]}">
                                <form class="position-relative show" data-bs-toggle="search" data-bs-display="static" aria-expanded="true" action="{{route('search_vacancy')}}" method="get">
                        ...
                        <table class="table table-hover table-striped overflow-hidden">
                            ...
                            @foreach($vacancies as $vacancy)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div>
                                            <a href="{{route('vacancy.edit' , $vacancy['id'])}}" style="text-decoration: none">
