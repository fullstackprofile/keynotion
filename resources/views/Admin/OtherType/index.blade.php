...
@section('title', 'Admin - All Other Types For ticket')
@section('content')
    <div class="card mb-3">
                    ...
                    <div class="row justify-content-center justify-content-sm-between">
                        ...
                        <div  class="col-sm-auto text-center">
                            <div class="search-box" data-list="{&quot;valueNames&quot;:[&quot;title&quot;]}">
                                <form class="position-relative show" data-bs-toggle="search" data-bs-display="static" aria-expanded="true" action="{{route('search_other_type')}}" method="get">
                    ...
                    <div class="table-responsive scrollbar">
                        <table class="table table-hover table-striped overflow-hidden">
                            ...
                            @foreach($other_types as $other_type)
                                <tr>
                                    <td>{{$other_type['id']}}</td>
                                    <td>{{$other_type['title']}}</td>
                                    <td class="text-end">
                                        <div>
                                            <a href="{{route('other_type.edit' , $other_type['id'])}}" style="text-decoration: none">
                                                <button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                </button>
                                                <span class="text-500 fas fa-edit"></span>
                                            </a>
                                            <form action="{{route('other_type.destroy' , $other_type['id'])}}" method="post"
