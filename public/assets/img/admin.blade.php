                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                ...
                                <a class="nav-link dropdown-indicator" href="#email" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="email">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-envelope-open"></span></span><span class="nav-link-text ps-1">Notifications</span></div>
                                </a>
                                <ul class="nav collapse" id="email">
                                    <li class="nav-item"><a class="nav-link" href="{{route('comments')}}" data-bs-toggle="" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Comments</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                </ul><!-- parent pages-->
                                ...
                                <ul class="nav collapse" id="news">
                                    ...
                                    <li class="nav-item"><a class="nav-link dropdown-indicator collapsed" href="#news_cat" data-bs-toggle="collapse" aria-expanded="false" aria-controls="e-commerce">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">News Categories</span></div>
                                        </a><!-- more inner pages-->
                                        <ul class="nav collapse" id="news_cat" style="">
                                            <li class="nav-item"><a class="nav-link" href="{{route('news_category.create')}}" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center">
                                                        <span class="nav-link-text ps-1">Create</span>
                                                    </div>
                                                </a><!-- more inner pages-->
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="{{route('news_category.index')}}" data-bs-toggle="" aria-expanded="false">
                                                    <div class="d-flex align-items-center">
                                                        <span class="nav-link-text ps-1"> Listing</span>
                                                    </div>
                                                </a><!-- more inner pages-->
                                ...
                                <a class="nav-link dropdown-indicator" href="#subscriber" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="user">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-user"></span></span><span class="nav-link-text ps-1">Subscribers</span></div>
                                </a>
                                <ul class="nav collapse" id="subscriber">
                                    <li class="nav-item"><a class="nav-link" href="{{route('subscribers')}}" data-bs-toggle="" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Subscribers Listing</span></div>
                                        </a><!-- more inner pages-->
                                    </li>
                                </ul>
                            </li>
                                        ...
                                        <div class="row">
                                            <div class="col-6 col-xxl-3">
                                                <div class="nav flex-column">
                                                   ...
                                                   <a class="nav-link py-1 link-600 fw-medium" href="{{route('event.create')}}">Create Event</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('event.index')}}">Events listing</a>
                                                    <p class="nav-link text-700 mb-0 fw-bold">Event's Categories</p>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('category.create')}}">Create Category</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('category.index')}}">Categories listing</a>
                                                    <p class="nav-link text-700 mb-0 fw-bold">Event's Place</p>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('place.create')}}">Create Place</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('place.index')}}">Places listing</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 col-xxl-3">
                                                <div class="nav flex-column">
                                                    ...
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('ticket.create')}}">Create Ticket</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('ticket.index')}}">Tickets listing</a>
                                                    <p class="nav-link text-700 mb-0 fw-bold">Ticket's Items</p>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('item.create')}}">Create Item</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('item.index')}}">Items listing</a>
                                                    <p class="nav-link text-700 mb-0 fw-bold">Ticket's 1st type</p>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('type.create')}}">Create 1st type</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('type.index')}}">1st type listing</a>
                                                    <p class="nav-link text-700 mb-0 fw-bold">Ticket's 2nd type</p>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('other_type.create')}}">Create 2nd type</a>
                                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('other_type.index')}}">2nd type listing</a>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="documentations">User management</a>
                            <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="documentations">
                                <div class="bg-white dark__bg-1000 rounded-3 py-2">
                                    ...
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('speaker.create')}}">Create speaker</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('speaker.index')}}">Speakers listing</a>
                                    <p class="nav-link text-700 mb-0 fw-bold">Attenders</p>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('attender.create')}}">Create attender</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('attender.index')}}">Attenders listing</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="documentations">Sponsors and Media Partners</a>
                            <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="documentations">
                                <div class="bg-white dark__bg-1000 rounded-3 py-2">
                                    <p class="nav-link text-700 mb-0 fw-bold">Sponsors</p>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('sponsor.create')}}">Create Sponsor</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('sponsor.index')}}">Sponsors listing</a>
                                    <p class="nav-link text-700 mb-0 fw-bold">Partners</p>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('partner.create')}}">Create Partner</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('partner.index')}}">Partners listing</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="documentations">Vacancy</a>
                            <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="documentations">
                                <div class="bg-white dark__bg-1000 rounded-3 py-2">
                                    ...
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('vacancy.create')}}">Create Vacancy</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('vacancy.index')}}">Vacancies listing</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="documentations">News</a>
                            <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="documentations">
                                <div class="bg-white dark__bg-1000 rounded-3 py-2">
                                    ...
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('sponsor.create')}}">Create News</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('sponsor.index')}}">News listing</a>
                                    <p class="nav-link text-700 mb-0 fw-bold">News Category</p>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('news_category.create')}}">Create Category</a>
                                    <a class="nav-link py-1 link-600 fw-medium" href="{{route('news_category.index')}}">Categories listing</a>
                                </div>
                            </div>
                        </li>
                    </ul>
